...
public class NhapHangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urldetailbill=Connect.address+"/kiemtranhapvattu.php";
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET,urlsp, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    mySpinner.setAdapter(new ArrayAdapter<String>(NhapHangActivity.this,android.R.layout.simple_spinner_dropdown_item,arraytenloai));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(NhapHangActivity.this, "loi tạo hóa đơn"+error, Toast.LENGTH_SHORT).show();
    ...
    private void Createbill()
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, urlpost, new Response.Listener<String>() {
                ...
                try {
                    ...
                    for(int i=0;i<array.length();i++)
                    {
                        ...
                        if(success==1)
                        {
                            ...
                            Toast.makeText(NhapHangActivity.this,message, Toast.LENGTH_SHORT).show();
                            txtmahd.setText(String.valueOf(mahd));
                    ...
                    e.printStackTrace();
                    Toast.makeText(NhapHangActivity.this, "loi tao hoa don"+e, Toast.LENGTH_LONG).show();
                }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NhapHangActivity.this, "loi duong dan"+error, Toast.LENGTH_LONG).show();
            }
        }){
            @Override
    ...
    private void Eventadd()
    {
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(NhapHangActivity.this, "Bạn vui lòng nhập đầy đủ tên khách hàng và số lượng", Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    private void getdata()
    {
        ...
        StringRequest request=new StringRequest(Request.Method.POST, urldisplay, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                {
                    e.printStackTrace();
                    Toast.makeText(NhapHangActivity.this, "loi cthd"+e, Toast.LENGTH_LONG).show();
                }
                hoaDonAdapTer.notifyDataSetChanged();
            }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NhapHangActivity.this, "loi duong link len CTHD"+error, Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError
        ...
        luu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest=new StringRequest(Request.Method.POST, urlupdate, new Response.Listener<String>() {
                    ...
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(NhapHangActivity.this, "loi duong dan hoadon"+error, Toast.LENGTH_SHORT).show();
                    }
                }){
                    @Override
                    protected Map<String, String> getParams() throws AuthFailureError {
